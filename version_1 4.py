...
def main():
    ...
    for e in range(int(numeros_de_dias_a_simular) + 1):
        ...
        print("%.2f\t\t%.2f\t(%.5e, %.5e)\t(%.5e, %.5e)\t\t%.5e" % (tiempo_total, tiempo_total / 86400, fuerza_gravitatoria_total[0], fuerza_gravitatoria_total[1], posicion_luna[0], posicion_luna[1], distancia_tierra_luna[1]))
